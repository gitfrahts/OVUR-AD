...
Download RoadAnomaly Dataset from https://datasets-cvlab.epfl.ch/2019-road-anomaly/RoadAnomaly.zip and unzip it like
...
Pretrained models
Download pretrained models from [Google Drive]. Place pth file in ./pretrained directory.
